...
SPECTACULAR_SETTINGS = {
    "TITLE": "Paperflow AI REST API",
    "DESCRIPTION": "OpenAPI Spec for Paperflow AI",
    "VERSION": "6.0.0",
...
EMAIL_SUBJECT_PREFIX: Final[str] = "[Paperflow AI] "
EMAIL_TIMEOUT = 30.0
...
MFA_TOTP_ISSUER = "Paperflow AI"

ACCOUNT_EMAIL_SUBJECT_PREFIX = "[Paperflow AI] "
